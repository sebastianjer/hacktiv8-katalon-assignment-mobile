...
//click the name, clear text, and click ok without inputting new name
...
//verify error message "Invalid Name Input"
Mobile.verifyElementText(findTestObject('Object Repository/Profile/User Profile/Error Invalid Input'), "Invalid Name Input")