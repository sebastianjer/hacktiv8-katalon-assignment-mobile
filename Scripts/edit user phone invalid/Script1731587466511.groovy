...
//click the phone number, clear text, and click ok without inputting new phone number
Mobile.tap(findTestObject('Object Repository/Profile/User Profile/View Phone'), 3)
...
//verify error message "Invalid Phone Input"
Mobile.verifyElementText(findTestObject('Object Repository/Profile/User Profile/Error Invalid Input'), "Invalid Phone Input")